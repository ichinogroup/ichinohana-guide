const data = {
  en: {
    ...
    items: [
      ["Before entering the house", "Please remove your shoes and keep noise low after 10 PM."],
      ["Light switches", "Main switches are near the entrance and beside the bed."],
      ["Air conditioner", "Use the remote control. Cooling: 24°C, Heating: 26°C recommended."],
      ["Water heater", "Adjust the central water temperature carefully. Default is 42°C."],
  ...
  jp: {
    ...
    subtitle: "重要情報",
    items: [
      ["入室前", "靴を脱いでください。夜10時以降は静かにしてください。"],
      ...
      ["ゴミ捨て", "燃えるゴミ、プラスチック、缶・瓶を分別してください。"],
